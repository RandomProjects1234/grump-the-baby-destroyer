...
import { makeBigKid, makeGrump, setGrumpStage, animateWalk } from '../render/models.js?v=2026-09-13c';
import { clamp, lerp, approachAngle, makeRng, hashStr } from '../util/util.js?v=2026-09-13c';
import { GRUMP_TURNS_ON_DAY } from './threats.js?v=2026-09-13c';
