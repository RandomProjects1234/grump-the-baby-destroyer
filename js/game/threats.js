...
import { Walker, canSee } from './nav.js?v=2026-09-13f';
import { makeBob, makeGrump, setGrumpStage, animateWalk, poseCarry } from '../render/models.js?v=2026-09-13f';
import { clamp, approachAngle, dist2, lerp } from '../util/util.js?v=2026-09-13f';
import { AMBIENT } from './dialogue.js?v=2026-09-13f';
